...
{
    /// <summary>
    /// Represents a platform service offered by a brand (e.g. Enterprise AI, Neural Predictive Analytics).
    /// </summary>
    public class CmsService
    {
        ...
        /// <summary>Material Symbols icon name: e.g. "psychology", "analytics", "hub".</summary>
