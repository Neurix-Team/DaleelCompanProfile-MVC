        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoDarkPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ShortDescEn = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ShortDescAr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionEn = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DescriptionAr = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ClientNameEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ClientNameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CmsProjects_BrandProfiles_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CmsServices_BrandProfiles_BrandId",
                        column: x => x.BrandId,
                        principalTable: "BrandProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamMembers_BrandProfiles_BrandId",
                        column: x => x.BrandId,
                        principalTable: "BrandProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleTitleEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RoleTitleAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Testimonials_BrandProfiles_BrandId",
                        column: x => x.BrandId,
                        principalTable: "BrandProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandProfiles_IsPublished",
                table: "BrandProfiles",
                column: "IsPublished");

            migrationBuilder.CreateIndex(
                name: "IX_BrandProfiles_Slug",
                table: "BrandProfiles",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CmsProjects_BrandId",
                table: "CmsProjects",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_CmsProjects_BrandId_Slug",
                table: "CmsProjects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CmsServices_BrandId",
                table: "CmsServices",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_CmsServices_BrandId_Slug",
                table: "CmsServices",
                columns: new[] { "BrandId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrmTasks_EntityType_EntityId",
                table: "CrmTasks",
                columns: new[] { "EntityType", "EntityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_BrandId",
                table: "TeamMembers",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_BrandId_Slug",
                table: "TeamMembers",
                columns: new[] { "BrandId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_IsPublished",
                table: "TeamMembers",
                column: "IsPublished");

            migrationBuilder.CreateIndex(
                name: "IX_Testimonials_BrandId",
                table: "Testimonials",
                column: "BrandId");
